...
niches = {
    "estetica": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: Copie e Cole agora essa Máquina de Seguidores com IA -</span> <span class="mobile-line">que traz pacientes premium para a</span> <span class="mobile-line gold">sua Clínica de Estética.</span></h1>',
        ...
        "prob_mecanismo": 'Existe um fenômeno comportamental chamado <strong style="color:var(--gold)">Fator Impulso</strong>. Na estética, as fotos de "Antes/Depois" rodam no tráfego pago pedindo a palavra "AVALIAÇÃO". Nossa IA chama na DM no exato milissegundo em que a paciente deseja a transformação, convertendo o impulso em agendamento imediato na sua recepção.<br><br><div class="mecanismo-visual" style="text-align: center; margin: 40px 0;"><picture><source media="(max-width: 768px)" srcset="assets/mecanismos/estetica-mobile.png"><img src="assets/mecanismos/estetica-desktop.png" alt="Mecanismo Estética" style="max-width: 100%; height: auto; border: 1px solid var(--gold); border-radius: 12px;"></picture></div>',
    ...
    "medicos": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: Copie e Cole agora essa Máquina de Seguidores com IA -</span> <span class="mobile-line">que traz pacientes particulares para</span> <span class="mobile-line gold">seu Consultório Médico.</span></h1>',
        ...
        "prob_mecanismo": 'Existe um método de conversão inviolável chamado <strong style="color:var(--gold)">Isca Ética</strong>. Para o médico (e o CFM), a nossa IA entrega um material gratuito de alto valor automatizado antes de "vender" a consulta. Isso mantém a ética intacta, gera reciprocidade e qualifica o paciente brutalmente.<br><br><div class="mecanismo-visual" style="text-align: center; margin: 40px 0;"><picture><source media="(max-width: 768px)" srcset="assets/mecanismos/medicos-mobile.png"><img src="assets/mecanismos/medicos-desktop.png" alt="Mecanismo Médicos" style="max-width: 100%; height: auto; border: 1px solid var(--gold); border-radius: 12px;"></picture></div>',
    ...
    "dentistas": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: Copie e Cole agora essa Máquina de Seguidores com IA -</span> <span class="mobile-line">que fecha orçamentos premium para</span> <span class="mobile-line gold">Consultórios Odontológicos.</span></h1>',
        ...
        "prob_mecanismo": 'Existe um fenômeno comportamental chamado <strong style="color:var(--gold)">Fator Impulso</strong>. Na odontologia de alto padrão, depoimentos em vídeo rodam pedindo a palavra "AVALIAÇÃO". Nossa IA entra em ação na DM no exato instante em que o paciente quer aquele sorriso novo, convertendo desejo em orçamento fechado.<br><br><div class="mecanismo-visual" style="text-align: center; margin: 40px 0;"><picture><source media="(max-width: 768px)" srcset="assets/mecanismos/dentistas-mobile.png"><img src="assets/mecanismos/dentistas-desktop.png" alt="Mecanismo Dentistas" style="max-width: 100%; height: auto; border: 1px solid var(--gold); border-radius: 12px;"></picture></div>',
    ...
    "advogados": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: Copie e Cole agora essa Máquina de Seguidores</span> <span class="mobile-line">que traz com ÉTICA clientes rentáveis para</span> <span class="mobile-line gold">Escritórios de Advocacia - com IA.</span></h1>',
        ...
        "prob_mecanismo": 'Existe um método de conversão inviolável chamado <strong style="color:var(--gold)">Isca Ética</strong>. Para bancas jurídicas e a OAB, a nossa IA entrega um manual de direitos básicos gratuito de forma automatizada antes de falar de honorários. Isso mantém a captação dentro da lei, gera reciprocidade e traz clientes prontos.<br><br><div class="mecanismo-visual" style="text-align: center; margin: 40px 0;"><picture><source media="(max-width: 768px)" srcset="assets/mecanismos/advogados-mobile.png"><img src="assets/mecanismos/advogados-desktop.png" alt="Mecanismo Advogados" style="max-width: 100%; height: auto; border: 1px solid var(--gold); border-radius: 12px;"></picture></div>',
    ...
    "psicologos": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: Copie e Cole agora essa Máquina de Seguidores com IA</span> <span class="mobile-line">para lotar suas sessões e</span> <span class="mobile-line gold">sua Clínica Psicológica.</span></h1>',
    ...
    "nutricionistas": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: Copie e Cole agora essa Máquina de Seguidores com IA -</span> <span class="mobile-line">que atrai pacientes particulares para</span> <span class="mobile-line gold">Consultórios e Clínicas de Nutricionistas.</span></h1>',
        ...
        "prob_mecanismo": 'Existe um fenômeno comportamental chamado <strong style="color:var(--gold)">Fator Impulso</strong>. Na nutrição, posts de transformação ou qualidade de vida rodam no tráfego pago pedindo a palavra "PLANO". Nossa IA entra em ação na DM no exato milissegundo em que o paciente deseja aquela mudança, convertendo o impulso em agendamento imediato da sua consulta particular.<br><br><div class="mecanismo-visual" style="text-align: center; margin: 40px 0;"><picture><source media="(max-width: 768px)" srcset="assets/mecanismos/nutricionistas-mobile.png"><img src="assets/mecanismos/nutricionistas-desktop.png" alt="Mecanismo Nutricionistas" style="max-width: 100%; height: auto; border: 1px solid var(--gold); border-radius: 12px;"></picture></div>',
...
def generate():
    ...
    for niche, data in niches.items():
        ...
        if niche in ["nutricionistas", "dentistas", "medicos", "estetica", "advogados"]:
            new_html = new_html.replace('/oferta11-slider-mensagens-antes-hq.png', f'assets/handoff-oferta16/{niche}-antes.png')
            new_html = new_html.replace('/oferta11-slider-mensagens-depois-hq.png', f'assets/handoff-oferta16/{niche}-depois.png')
