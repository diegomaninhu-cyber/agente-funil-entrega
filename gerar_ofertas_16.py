...
niches = {
    "estetica": {
        "title": '<h1 class="hero-title"><span class="mobile-line">Copy e Cole CLAUDE: a máquina de seguidores</span> <span class="mobile-line">que vende pacientes premium para a</span> <span class="mobile-line gold">sua Clínica de Estética.</span></h1>',
    ...
    "medicos": {
        "title": '<h1 class="hero-title"><span class="mobile-line">Copy e Cole CLAUDE: a máquina de seguidores</span> <span class="mobile-line">que traz pacientes particulares para</span> <span class="mobile-line gold">Consultórios Médicos.</span></h1>',
    ...
    "dentistas": {
        "title": '<h1 class="hero-title"><span class="mobile-line">Copy e Cole CLAUDE: a máquina de seguidores</span> <span class="mobile-line">que fecha orçamentos premium para</span> <span class="mobile-line gold">Consultórios Odontológicos.</span></h1>',
    ...
    "advogados": {
        "title": '<h1 class="hero-title"><span class="mobile-line">Copy e Cole CLAUDE: a máquina de seguidores</span> <span class="mobile-line">que traz clientes rentáveis para</span> <span class="mobile-line gold">Escritórios de Advocacia.</span></h1>',
    ...
    "psicologos": {
        "title": '<h1 class="hero-title"><span class="mobile-line">Copy e Cole CLAUDE: a máquina de seguidores</span> <span class="mobile-line">que escala as suas sessões e lota</span> <span class="mobile-line gold">sua Clínica Psicológica.</span></h1>',
