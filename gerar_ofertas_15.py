...
niches = {
    "estetica": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: A Máquina B2B que</span> <span class="mobile-line">vende pacientes premium para a</span> <span class="mobile-line gold">sua Clínica de Estética.</span></h1>',
    ...
    "medicos": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: A Máquina B2B que</span> <span class="mobile-line">traz pacientes particulares para</span> <span class="mobile-line gold">Consultórios Médicos.</span></h1>',
    ...
    "dentistas": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: A Máquina B2B que</span> <span class="mobile-line">fecha orçamentos premium para</span> <span class="mobile-line gold">Consultórios Odontológicos.</span></h1>',
    ...
    "advogados": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: A Máquina B2B que</span> <span class="mobile-line">traz clientes rentáveis para</span> <span class="mobile-line gold">Escritórios de Advocacia.</span></h1>',
    ...
    "psicologos": {
        "title": '<h1 class="hero-title"><span class="mobile-line">CLAUDE: A Máquina B2B que</span> <span class="mobile-line">escala as suas sessões e lota</span> <span class="mobile-line gold">sua Clínica Psicológica.</span></h1>',
...
def generate():
    ...
    for niche, data in niches.items():
        ...
        out_name = f"oferta15_{niche}.html"
